...
#SBATCH --gres=gpu:a100:1 -C a100_40
#SBATCH --export=NONE
...
torchrun --nproc_per_node=1 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/jepa_wt_batch_time_enc.yaml --batch_size=20 --epochs=400 --extra_tag=Overfit_Set_1_1_0 --tcp_port=$PORT --workers=8 --max_ckpt_save_num=10 --not_eval_with_train --scenario_id 103718491a34269 3c4c59a7d820467 cd7fdd75bfeddbe7 f13e51dfe26339b3 d2b602df5a0b1a54 8189fa99f7c98b1b 6ad806abcf93c8f8 66e1a1918dca9607 c384f3dfc60ec63a 9f42997ad8749585 307349a330fe74f6 d030f6dd4505e09c 13b07777432ecf75 824d951e9769df42 feacabfe2cb0aec6 eb86882e0873801b 123bb8fd87b7d9e2 8539e5a2686c2f91 b0454cdf7b34bdab 16c9ce803f090eb6 --set DATA_CONFIG.DATA_ROOT $TMPDIR MODEL.CONTEXT_ENCODER.mse_coeff 1.0 MODEL.CONTEXT_ENCODER.std_coeff 1.0 MODEL.CONTEXT_ENCODER.cov_coeff 0.0 MODEL.CONTEXT_ENCODER.TIME_ENCODER.TYPE set_transformer
