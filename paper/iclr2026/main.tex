...
future poses (99\% step coverage vs.\ zero future supervision) gives nearly
identical trajectory accuracy (0.6567 vs.\ 0.6532, $\Delta{=}0.5\%$), confirming
that the benefit arises entirely from the \emph{past} pose encoder, not from
future pose prediction quality.
