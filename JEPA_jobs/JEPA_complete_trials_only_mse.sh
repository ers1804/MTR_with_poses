...
torchrun --nproc_per_node=4 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/jepa_loss_trial.yaml --batch_size=120 --epochs=150 --extra_tag=Training_1_0_0 --tcp_port=$PORT --workers=16 --max_ckpt_save_num=150 --ckpt_save_interval=2 --set DATA_CONFIG.DATA_ROOT $TMPDIR MODEL.CONTEXT_ENCODER.USE_ATTN_POOL False MODEL.CONTEXT_ENCODER.std_coeff 0.0 MODEL.CONTEXT_ENCODER.cov_coeff 0.0
