...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/jepa_loss_trial_no_timestamps_freq_embedding.yaml --batch_size=232 --epochs=100 --extra_tag=Trial_1 --tcp_port=$PORT --workers=8 --max_ckpt_save_num=300 --ckpt_save_interval=2  --set DATA_CONFIG.DATA_ROOT $TMPDIR
