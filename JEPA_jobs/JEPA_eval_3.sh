...
torchrun --nproc_per_node=1 --rdzv_endpoint=localhost:${PORT} test.py --launcher pytorch --tcp_port=$PORT --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/mtr+100_percent_data_jepa_with_decoder.yaml --batch_size=30 --save_to_file --workers=0 --eval_all --extra_tag Full_Training_1_1_0001_50_Epochs_2_LR1 --eval_tag Full_Training_1_1_0001_50_Epochs_2_LR1_eval --ckpt_dir /home/atuin/v103fe/v103fe12/MTR_helma/MTR_with_poses/output/home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/mtr+100_percent_data_jepa_with_decoder/Full_Training_1_1_0001_50_Epochs_2_LR1/ckpt --set DATA_CONFIG.DATA_ROOT $TMPDIR
