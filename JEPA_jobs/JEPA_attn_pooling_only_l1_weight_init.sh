...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/mtr+100_percent_data_jepa_attn_pooling_only_l1_layer.yaml --batch_size=232 --epochs=100 --extra_tag=L1_Layer_Init --tcp_port=$PORT --workers=8 --ckpt_save_interval=5 --max_ckpt_save_num=300 --set DATA_CONFIG.DATA_ROOT $TMPDIR
