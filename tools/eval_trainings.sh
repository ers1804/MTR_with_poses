...
# torchrun --nproc_per_node=1 test.py --launcher pytorch --cfg_file cfgs/waymo/mtr+100_percent_data_jepa_with_decoder.yaml --batch_size=30 --extra_tag=Full_Training_1_1_0001_60_50_Epochs --eval_tag=Full_Training_1_1_0001_60_50_Epochs_eval --ckpt_dir=/home/erik/NAS/personal/jepa_eval/complete_experiments/Full_Training_1_1_0001_60_50_Epochs/ckpt --save_to_file --workers=8 --eval_all

# torchrun --nproc_per_node=1 test.py --launcher pytorch --cfg_file cfgs/waymo/mtr+100_percent_data_jepa_with_decoder.yaml --batch_size=30 --extra_tag=Full_Training_20_1_1_0001_80_50_Epochs --eval_tag=Full_Training_20_1_1_0001_80_50_Epochs_eval --ckpt_dir=/home/erik/NAS/personal/jepa_eval/complete_experiments/Full_Training_20_1_1_0001_80_50_Epochs/ckpt --save_to_file --workers=8 --eval_all

# torchrun --nproc_per_node=1 test.py --launcher pytorch --cfg_file cfgs/waymo/mtr+100_percent_data_jepa_with_decoder.yaml --batch_size=30 --extra_tag=Full_Training_1_1_0001_150_80_50_Epochs --eval_tag=Full_Training_1_1_0001_150_80_50_Epochs_eval --ckpt_dir=/home/erik/NAS/personal/jepa_eval/complete_experiments/Full_Training_1_1_0001_150_80_50_Epochs/ckpt --save_to_file --workers=8 --eval_all

torchrun --nproc_per_node=1 test.py --launcher pytorch --cfg_file cfgs/waymo/mtr+100_percent_data_jepa_with_decoder.yaml --batch_size=30 --extra_tag=Full_Training_1_1_0001_40_Epochs_Linear_Probing_Map --eval_tag=Full_Training_1_1_0001_40_Epochs_Linear_Probing_Map_eval --ckpt_dir=/home/erik/NAS/personal/jepa_eval/complete_experiments/Full_Training_1_1_0001_40_Epochs_Linear_Probing_Map/ckpt --save_to_file --workers=8 --eval_all

torchrun --nproc_per_node=1 test.py --launcher pytorch --cfg_file cfgs/waymo/mtr+100_percent_data_jepa_with_decoder.yaml --batch_size=30 --extra_tag=Full_Training_1_1_0001_40_Epochs_LR1_Helma --eval_tag=Full_Training_1_1_0001_40_Epochs_LR1_Helma_eval --ckpt_dir=/home/erik/NAS/personal/jepa_eval/complete_experiments/Full_Training_1_1_0001_40_Epochs_LR1_Helma/ckpt --save_to_file --workers=8 --eval_all

torchrun --nproc_per_node=1 test.py --launcher pytorch --cfg_file cfgs/waymo/mtr+100_percent_data_jepa_with_decoder.yaml --batch_size=30 --extra_tag=Full_Training_1_1_0001_512_150 --eval_tag=Full_Training_1_1_0001_512_150_eval --ckpt_dir=/home/erik/NAS/personal/jepa_eval/complete_experiments/Full_Training_1_1_0001_512_150/ckpt --save_to_file --workers=8 --eval_all --set MODEL.CONTEXT_ENCODER.D_MODEL 512