...
#SBATCH --output=/home/atuin/v103fe/v103fe12/outputs/base_training_%j.txt
...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/mtr+100_percent_data.yaml --batch_size=120 --epochs=40 --extra_tag=Base_Full_40_512 --tcp_port=${PORT} --workers=8 --not_eval_with_train --max_ckpt_save_num=40 --set DATA_CONFIG.DATA_ROOT $TMPDIR MODEL.CONTEXT_ENCODER.D_MODEL 512 OPTIMIZATION.DECAY_STEP_LIST [32,34,36,38]
