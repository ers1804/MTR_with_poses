...
torchrun --nproc_per_node=2 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/jepa_wt_batch_20.yaml --batch_size=40 --epochs=40 --extra_tag=Trial_1_1_0_Cosine --tcp_port=$PORT --workers=8 --max_ckpt_save_num=5 --ckpt_save_interval=2 --set DATA_CONFIG.DATA_ROOT $TMPDIR
