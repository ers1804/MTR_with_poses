...
torchrun --nproc_per_node=4 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/mtr+100_percent_data_jepa_with_decoder_vit.yaml --batch_size=48 --epochs=40 --extra_tag=Full_Training_1_1_0001_150_Vit_Attn --tcp_port=$PORT --workers=16 --not_eval_with_train --max_ckpt_save_num=40 --set DATA_CONFIG.DATA_ROOT $TMPDIR MODEL.CONTEXT_ENCODER.USE_ATTN_POOL True MODEL.CONTEXT_ENCODER.JEPA_WEIGHTS_PATH /home/atuin/v103fe/v103fe12/MTR_helma/MTR_with_poses/output/home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/jepa_loss_trial_vit/Training_1_1_0001_150_Vit_Helma/ckpt/checkpoint_epoch_145.pth MODEL.CONTEXT_ENCODER.PARAMS_TO_FREEZE "['agent_polyline_encoder','self_attn_layers','attention_pooling']" OPTIMIZATION.DECAY_STEP_LIST "[32,34,36,38]"
