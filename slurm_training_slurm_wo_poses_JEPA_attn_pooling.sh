...
#SBATCH --output=/home/atuin/v103fe/v103fe12/outputs/jepa_pretraining_attn_pooling_6_%j.txt
...
torchrun --nproc_per_node=8 --rdzv_endpoint=localhost:${PORT} train.py --launcher pytorch --cfg_file /home/atuin/v103fe/v103fe12/MTR/tools/cfgs/waymo/mtr+100_percent_data_jepa_attn_pooling.yaml --batch_size=232 --epochs=300 --extra_tag=Jepa_wo_poses_attn_pooling_local_8a100_long_normalized_representation --tcp_port=$PORT --workers=8 --not_eval_with_train --max_ckpt_save_num=300 --set DATA_CONFIG.DATA_ROOT $TMPDIR
